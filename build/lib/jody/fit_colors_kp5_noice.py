...
class Colors():
	...
	def plot_fit(self,row,constraints, outspec='KP5_noice.fits'):
		...
		carfile = 'opacity_carbon_1.0_amax_7.0_h2o_0_alpha_-1.75.fits'
		silfile = 'opacity_carbon_0.0_amax_0.65_h2o_0_alpha_-2.0.fits'
		frac = 0.35
		...
		fig = plt.figure(figsize=(5,4))
		ax = fig.add_subplot(111)
		ax.plot(caropac['wavelength'],best_kext/np.interp(2.2,caropac['wavelength'],best_kext),label='KP5 No Ice (OpTool)',color='purple',lw=2)
...
colors = Colors('../grid_v3.0/',regen_colors=False)
